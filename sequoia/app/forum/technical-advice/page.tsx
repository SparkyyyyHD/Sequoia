...
export default function ForumTechnicalAdvicePage() {
  if (!TECHNICAL_ADVICE) return null;
        ...
        {TECHNICAL_ADVICE.subsections.map((subsection) => (
          ...
          >
            <div className="flex items-start justify-between gap-1">
              <Link
                href={`/forum/technical-advice/${subsection.slug}`}
